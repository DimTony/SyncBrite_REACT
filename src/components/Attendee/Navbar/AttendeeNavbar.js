...
import ProfileDropdownItem from "../../Dashboard/Navbar/ProfileDropdown/ProfileDropdown";
...
function AttendeeNavbar({ error, isLoggedIn, userData, setUserData }) {
  ...
  const setNavIcon = () => {
    if (window.location.pathname === "/attendee/dashboard") {
      setHome(true);
      setGroup(false);
      setEvent(false);
      setNotification(false);
    } else if (window.location.pathname === "/attendee/groups") {
      setHome(false);
      setGroup(true);
      setEvent(false);
      setNotification(false);
    } else if (window.location.pathname === "/attendee/events") {
      setHome(false);
      setGroup(false);
      setEvent(true);
      setNotification(false);
    } else if (window.location.pathname === "/attendee/notifications") {
      setHome(false);
      setGroup(false);
      setEvent(false);
    ...
    <>
      <nav>
        ...
        {isLoggedIn ? (
          ...
          <div>
            <h1>Access Denied: Unauthorized Request</h1>
