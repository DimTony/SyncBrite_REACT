...
function UserRightbar({ user, friend }) {
  ...
  const friendUnfriendAction = async () => {
    ...
    try {
      ...
      const response = await axios.patch(
        `https://syncbrite-server.onrender.com/api/profiles/friend/request/${userId}`,
        { value: valueToSend },
        {
  ...
  const acceptFriendRequest = async () => {
    ...
    try {
      const response = await axios.patch(
        `https://syncbrite-server.onrender.com/api/profiles/friend/${userId}`,
        { value: "accept" },
        {
          withCredentials: true,
          headers: { Authorization: `Bearer ${syncToken}` },
  ...
  const followUnfollowAction = async () => {
    ...
    try {
      ...
      const response = await axios.patch(
        `https://syncbrite-server.onrender.com/api/profiles/follow/${userId}`,
        { value: valueToSend },
        {
          withCredentials: true,
          headers: { Authorization: `Bearer ${syncToken}` },
